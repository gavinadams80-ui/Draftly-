  ...
  const submissionSheets = useMemo<(ExportSheet & { description?: string })[]>(() => {
    ...
    sheets.push({
      ...
      svg: withTitleBlock(generateWallSectionSVG(
        ...
        true, calc.selGableChord?.sec.d ?? 150, 'back', calc.selPost?.sec.d ?? 100, calc.selBeam?.sec.d ?? 250,
    ...
    sheets.push({
      ...
      svg: withTitleBlock(generateWallSectionSVG(
        config.depth * 1000, config.pitch,
        calc.selPurlin?.sec.d ?? 100, calc.selPurlin?.sec.b ?? 50, calc.selPurlin?.sec.t ?? 1.5,
        false, 150, 'intermediate', calc.selPost?.sec.d ?? 100, calc.selBeam?.sec.d ?? 250,
    ...
    sheets.push({
      ...
      svg: withTitleBlock(generateWallSectionSVG(
        config.depth * 1000, config.pitch,
        calc.selPurlin?.sec.d ?? 100, calc.selPurlin?.sec.b ?? 50, calc.selPurlin?.sec.t ?? 1.5,
        true, calc.selGableChord?.sec.d ?? 150, 'front', calc.selPost?.sec.d ?? 100, calc.selBeam?.sec.d ?? 250,
